...
public class ArenaDisableArg
{

    public static void DisableCommand(Player player, String label, String[] args)
    {
        if (args.length == 2)
        {
            ...
            if (arena != null)
            {
                if (arena.isEnabled())
                {
                    ...
                    player.sendMessage(StringUtil.CC("&cArena is already disabled."));
            }
            else
